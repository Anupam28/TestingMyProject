...
public class CreateProspectList extends TestBase {
	...
	public void createPospectList() throws InterruptedException{
		...
		getObject("prospect_first_name_input").sendKeys("prospectfirst26");
		getObject("prospect_last_name_input").sendKeys("prospectlast26");
		getObject("prospect_emailid-input").sendKeys("laptopipad26@gmail.com");
		getObject("prospect_company_input").sendKeys("Padrot26");
		getObject("prospect_compaign_dropdown").sendKeys("Email test 1");
		getObject("prospect_profile_dropdown").sendKeys("Adil Yellow Jackets 1");
		getObject("prospect_score_input").sendKeys("1");
		*/
